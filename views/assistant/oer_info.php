...
<table class="default">
    ...
    <tr>
        ...
        <td>Meta-Suche für freie Materialien aller Art (auch Bilder)') ?></td>
    </tr>
    <tr>
        <td>OER-Hörnchen</td>
        <td><a href="https://oerhoernchen.de">https://oerhoernchen.de</a></td>
        <td>Meta-Suche für freie OER-Materialien mit deutschem Fokus') ?></td>
    </tr>
    <tr>
        ...
        <td>Speziell für Hochschulen: Meta-Suche für freie OER-Materialien mit deutschem Fokus') ?></td>
    </tr>
    <tr>
        <td>OER-Commons</td>
        <td><a href="https://www.oercommons.org">https://www.oercommons.org</a></td>
        <td>Die größte internationale OER-Sammlung.') ?></td>
    </tr>
    <tr>
        ...
        <td>Besonders empfehlenswert: Lehrbuchsammlung und weitere Hochschul-Links.') ?></td>
    </tr>
    <tr>
        <td>OERinform</td>
        <td><a href="https://oer.amh-ev.de">https://oer.amh-ev.de</a></td>
        <td>OER-Informationen der Arbeitsgemeinschaft der Medieneinrichtungen an Hochschulen.') ?></td>
